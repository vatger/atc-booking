...
$stationsFile = fopen(_DATA_PATH_ . "edbb_allstations.csv", "r") or die("Unable to open allstations file!");
$minStationsFile = fopen(_DATA_PATH_ . "edbb_minstations.csv", "r") or die("Unable to open minstations file!");
$allStationsString = fgets($stationsFile);
$minStationsString = fgets($minStationsFile);


$bookingsString = file_get_contents(_DATA_PATH_ . "edbb_weekly.json") or die("Unable to open weekly file!");
